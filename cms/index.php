                                    ...
                                    <div class="col-12 col-sm-10 col-md-10 col-lg-10 offset-sm-1 offset-md-1 offset-lg-1">
                                        <form action="authenticate-cms.php" method="POST">
                                            <div class="row text-center">
                                                ...
                                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 mt-4">
                                                    <input id="signin-password" class="form-control" type="password" name="getPassword" placeholder="Password" value="">
                                                </div>
                                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 mt-4 mb-3">
                                                    <button type="submit" value="submit" class="btn btn-primary enbtn btn-block" name="signin-submit">SUBMIT</button>
                                                </div>
                                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 mt-4 mb-3">
